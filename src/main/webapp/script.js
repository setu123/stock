Ext.define('Pressure', {extend: 'Ext.data.Model', fields: ['code', 'pressure', 'volumeChange', 'hammer', 'cLengthChange', 'consecutiveGreen', 'tradeChange', 'rsi', 'divergence', 'signal', {name: 'publics', mapping: 'sharePercentage.publics'}, 'totalSecurity', 'paidUpCapital', {name: 'reserve', convert: function (v, record) {
...
var consecutiveGreen = Ext.create('Ext.grid.column.Column', {header: 'CGreen', dataIndex: 'consecutiveGreen', width: 60, readOnly: true, hidden: true, filter: {}});
...
var signal = Ext.create('Ext.grid.column.Column', {header: 'Signal', dataIndex: 'signal', width: 60, readOnly: true, filter: {}, renderer:function(value, record){
        if(value==='BUY' || value==='AVG')
...
//        return publicShare.toFixed(1);
//}});
var publicS = Ext.create('Ext.grid.column.Column', {header: 'publicS', dataIndex: 'publicShare', width: 60, readOnly: true});
var reserve = Ext.create('Ext.grid.column.Column', {header: 'Reserve', dataIndex: 'reserve', width: 60, readOnly: true, hidden: true});
var paidup = Ext.create('Ext.grid.column.Column', {header: 'Paidup', dataIndex: 'paidUpCapital', width: 60, readOnly: true, filter: {}});
