 ...
 * @author setu
 */
public class MultipleSma25Intersect extends BuySignalCalculator {

    public MultipleSma25Intersect(ScannerService scanner, CustomHashMap oneYearData, Portfolio portfolio) {
    ...
    public boolean isBuyCandidate(List<Item> itemSubList, Item calculated) {
        ...
        if (
                (todayGap >= 1.2 && oneFourthWay > sma25 && today.getOpenPrice() <= (sma25 * 1.000))
