 ...
 * @author setu
 */
public class ThreeGreen extends BuySignalCalculator {

    public ThreeGreen(ScannerService scanner, CustomHashMap oneYearData, Portfolio portfolio) {
    ...
    public boolean isBuyCandidate(List<Item> itemSubList, Item calculated) {
        ...
        if (((todaychange >= 1 && todayGap >= 1.2) && (yesterdayGap > 0 && dayBeforeYesterdayGap > 0) && (todaychange + yesterdaychange) > 1)
